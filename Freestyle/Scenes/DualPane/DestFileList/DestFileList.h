...
class CDestFileList : ConfigurableList
{
private :
	struct {
...
public:
	static vector<FileInformation> m_FileItemsDest;
	static FileBrowser m_FileBrowserDest;
	static bool Shift;

    XUI_IMPLEMENT_CLASS( CDestFileList, L"DestFilesList", XUI_CLASS_LIST );

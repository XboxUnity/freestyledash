...
#include "../ManagePaths/ScnManagePaths.h"

class CScnParentContentSettings : CXuiSceneImpl
{
public:
	...
	// Implement Class
    XUI_IMPLEMENT_CLASS( CScnParentContentSettings, L"ScnParentContentSettings", XUI_CLASS_SCENE )
